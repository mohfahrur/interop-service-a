...
func (c *itemServiceClient) GetItem(ctx context.Context, in *ItemRequest, opts ...grpc.CallOption) (*ItemReply, error) {
	out := new(ItemReply)
...
func (UnimplementedItemServiceServer) GetItem(context.Context, *ItemRequest) (*ItemReply, error) {
